...
class TratamientoController {
    ...
    public function __construct() {
        $this->tratamientoModel = new Tratamiento(); // Crea una instancia del modelo Tratamiento.
        $this->pacienteModel = new PacienteModulo(); // Crea una instancia del modelo Paciente (se asume que la clase es PacienteModulo).
    }
